...
public class GitattributesCommentImpl extends ASTWrapperPsiElement implements GitattributesComment {

  public GitattributesCommentImpl(@NotNull ASTNode node) {
    super(node);
  }
