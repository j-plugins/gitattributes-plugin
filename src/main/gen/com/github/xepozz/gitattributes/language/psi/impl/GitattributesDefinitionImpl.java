...
public class GitattributesDefinitionImpl extends ASTWrapperPsiElement implements GitattributesDefinition {

  public GitattributesDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public GitattributesUnaryDefinition getUnaryDefinition() {
    return findNotNullChildByClass(GitattributesUnaryDefinition.class);
  }
